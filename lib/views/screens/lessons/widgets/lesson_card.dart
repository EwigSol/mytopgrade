...
class LessonCard extends StatelessWidget {
  ...
  var id;
  bool? isLocked;
  LessonCard({Key? key, required this.id, required this.title, required this.duration, required this.isLocked, required this.index}) : super(key: key);
    ...
    return Padding(
      ...
      child: InkWell(
          onTap: () {
            ...
            if(isLocked == false){
              Navigator.push(context, MaterialPageRoute(builder: (context) => LessonViewScreen(id: id.toString())));
            }
          },
          child: Container(
