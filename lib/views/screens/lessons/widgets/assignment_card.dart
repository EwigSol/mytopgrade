...
class AssignmentCard extends StatelessWidget {
  ...
  var id;
  bool? isLocked;
  AssignmentCard({Key? key, required this.id, required this.title, required this.duration, required this.isLocked, required this.index}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
          onTap: () {
            if(isLocked == false){
              Navigator.push(context, MaterialPageRoute(builder: (context) => AssignmentViewScreen(id: id.toString())));
            }
          },
          child: Container(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Text(title, maxLines: 3, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold),),
                              duration != null ?
