...
class Playlist extends StatefulWidget {
  ...
  final bool isLocked;
  const Playlist({Key? key, this.coursesDetail, required this.isWishlist, this.favCourseDetail, this.myCoursesModel, required this.isMyCourse, required this.isLocked, this.courseByIdModel}) : super(key: key);
...
class _PlaylistState extends State<Playlist> {
  ...
  Widget build(BuildContext context) {
    ...
    //   ],
    // );
    widget.courseByIdModel!.sections!.isNotEmpty ?
    ListView.builder(
          ...
          return Padding(
            ...
            child: Container(
              ...
              child: ExpandablePanel(
                header: Padding(
                  padding: const EdgeInsets.only(top: AppPadding.p6, left: AppPadding.p12),
                  child: textStyle0_5(text: widget.courseByIdModel!.sections![index].title!),
                ),
                collapsed: Padding(
                  padding: const EdgeInsets.only(bottom: AppPadding.p6, left: AppPadding.p16),
                  child: Text("Videos: ${widget.courseByIdModel!.sections![index].items!.length} ", softWrap: true, maxLines: 2, overflow: TextOverflow.ellipsis,),
                ),
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    itemCount: widget.courseByIdModel!.sections![index].items!.length,
                    itemBuilder: (context, i){
                      return widget.courseByIdModel!.sections![index].items![i].type == Type.lpLesson ?
                      LessonCard(isLocked: widget.isLocked,
                          ...
                          index: i)
                      : widget.courseByIdModel!.sections![index].items![i].type == Type.lpQuiz ?
                      QuizCard(isLocked: widget.isLocked,
                          id: widget.courseByIdModel!.sections![index].items![i].id,
                          title: widget.courseByIdModel!.sections![index].items![i].title,
                          duration: widget.courseByIdModel!.sections![index].items![i].duration,
                          index: i)
                      :
                      AssignmentCard(isLocked: widget.isLocked,
                          id: widget.courseByIdModel!.sections![index].items![i].id,
                          title: widget.courseByIdModel!.sections![index].items![i].title,
                          duration: widget.courseByIdModel!.sections![index].items![i].duration,
                          index: i);
