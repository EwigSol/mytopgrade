...
class RetakeCourseController extends GetxController {
  ...
  Future<Map<String, dynamic>> purchaseCourse(String id) async {
    ...
    var response = await client.post(Uri.parse(APIBase.baseURL + APIPathHelper.getValue(APIPath.retakeCourse)),
        headers: {
