...
List<FinishedCoursesModel> finishedCoursesFromJson(String str) =>
    List<FinishedCoursesModel>.from(
        json.decode(str).map((x) => FinishedCoursesModel.fromJson(x)));

class FinishedCoursesModel {
  FinishedCoursesModel(
      {this.id,
      this.name,
      this.slug,
      this.permalink,
  ...
  factory FinishedCoursesModel.fromJson(Map<String, dynamic> json) =>
      FinishedCoursesModel(
        id: json["id"],
        name: json["name"],
        slug: json["slug"],
...
final evaluateTypeValues =
    EnumValues({"evaluate_lesson": EvaluateType.evaluateLesson});
...
final nameValues =
    EnumValues({"admin": Name.admin, "Stanley Akujiobi": Name.stanleyAkujiobi});
